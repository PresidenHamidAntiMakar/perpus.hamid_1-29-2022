...
if (isset($_POST['save'])) {
	...
	if ($query_insert){
		header("refresh:1, url=http://localhost/01_PASGANJIL_2021_XIIRPL2_ABDULHAMIDYASIRALFALAH/admin.php?page=buku");
	}else{
	...
	<tr>
		...
		<td valign="middle">
			<a href="?page=buku&hapus&id=<?php echo $row['id_buku']; ?>"> <!-- href digunakan untuk menambahkan $id untuk di hapus / edit -->
				...
				<a  href="?page=buku-edit&edit&id=<?php echo $row['id_buku'];?>">
